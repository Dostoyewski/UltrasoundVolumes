...
namespace UnityVolumeRendering
{
    public static class DensityHelper
    {
        ...
        {
            var source = DensitySource.Unknown;
        ...
        {
            var source = IdentifyDensitySource(colors);
        ...
        {
            var densities = new int[colors.Length];
        ...
        {
            var grey = source == DensitySource.Grey ? density / 255f : 0f;
            var alpha = source == DensitySource.Alpha ? density / 255f : 0f;
